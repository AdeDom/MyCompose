...
import compose.foundation.layout.LayoutOrientation.Horizontal
import compose.foundation.layout.LayoutOrientation.Vertical
...
internal sealed class CrossAxisAlignment {
    ...
    private object StartCrossAxisAlignment : CrossAxisAlignment() {
        override fun align(
            ...
            placeable: Placeable,
            beforeCrossAxisAlignmentLine: Int,
        ): Int = if (layoutDirection == LayoutDirection.Ltr) 0 else size
    }
    ...
    private object EndCrossAxisAlignment : CrossAxisAlignment() {
        override fun align(
            ...
            placeable: Placeable,
            beforeCrossAxisAlignmentLine: Int,
        ): Int = if (layoutDirection == LayoutDirection.Ltr) size else 0
    }
    ...
    private data class HorizontalCrossAxisAlignment(
        ...
        override fun align(
            ...
            placeable: Placeable,
            beforeCrossAxisAlignmentLine: Int,
        ): Int = horizontal.align(0, size, layoutDirection)
    }
}
...
internal class WithAlignmentLineBlockElement(
    ...
    override fun create(): SiblingsAlignedNode.WithAlignmentLineBlockNode =
        SiblingsAlignedNode.WithAlignmentLineBlockNode(block)
...
internal class WithAlignmentLineElement(
    ...
    override fun create(): SiblingsAlignedNode.WithAlignmentLineNode =
        SiblingsAlignedNode.WithAlignmentLineNode(alignmentLine)
...
internal sealed class SiblingsAlignedNode :
    Modifier.Node(),
    ParentDataModifierNode {
...
internal class HorizontalAlignElement(
    ...
    override fun create(): HorizontalAlignNode = HorizontalAlignNode(horizontal)
...
internal sealed class AlignmentLineProvider {
    ...
    data class Block(val lineProviderBlock: (Measured) -> Int) : AlignmentLineProvider() {
        override fun calculateAlignmentLinePosition(
            placeable: Placeable,
        ): Int = lineProviderBlock(placeable)
    }
